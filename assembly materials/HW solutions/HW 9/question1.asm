# File: Kann CH 9 Q1 PrintIntArray.asm
# Purpose: to print a array using a utilities files it can print in reverse and print normally
# author: Arshiya Salehi
#
# subprograms Index:
#	PrintIntArray	display the array
#	
...
# output:	$v0 - using the subprogam in the util files display a string
# sideeffect: print the number 
.text
PrintIntArray:
